...
ui <- dashboardPage(
  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(
        tabName = "bluechip",
        # Shared Universe N + Candidate truncate — above BLUE CHIP tabBox (all sub-tabs)
        fluidRow(
          column(
            width = 12,
        ...
        tabBox(
          ...
          tabPanel(
            ...
            p(
              ...
              "本次已評估檔的明細（按年化估值漲幅排序）。列數等於上方「宇宙檔數（N）」（不足則全列）。"
            ),
            tags$hr(),
            fluidRow(
              box(
          ...
          tabPanel(
            ...
            tags$p(
              ...
              paste0(
                ...
                "宇宙檔數 N 與候選截斷邏輯見區塊上方共用控制（市值／概念股／近一年漲幅／隨機；市值缺值則改依代號排序）。",
