  ...
  tagList(
    ...
    column(
      ...
      tags$p(
        ...
        "The YNow App (v17.21) 是一套專為專業投資人與分析師打造的「全方位量化財務與估值決策系統」。本系統整合了即時財報抓取、多維度估值模型與動態回測引擎，將繁雜的市場資料轉化為直覺、科學的投資決策。"
      ),
      tags$p(
    ...
    column(
      ...
      tags$p(
        class = "ynow-about-lead",
        "The YNow App (v17.21) is a comprehensive quantitative financial analysis and valuation decision system designed for professional investors and analysts. It seamlessly integrates real-time financial data parsing, multi-dimensional valuation models, and a dynamic backtesting engine to transform complex market data into actionable, scientific investment insights."
      ),
      tags$p(
        class = "ynow-about-method",
...
ui <- dashboardPage(
  ...
  dashboardHeader(
                title = HTML('<span class="ynow-app-title">The YNow App v17.21</span>'),
    titleWidth = 250,
    tags$li(
