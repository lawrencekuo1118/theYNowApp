...
.UI_STRINGS <- list(
  en = list(
    ...
    beta_advanced_note = "Peer unlever / Rolling β remain under {home} → BETA. CAPM (Rf / β / Rm) lives on DCF-Model → WACC.",
  ...
  `zh-TW` = list(
    ...
    beta_advanced_note = "同業去槓桿／Rolling β 仍在 {home} → BETA。CAPM（Rf／β／Rm）在 DCF-Model → WACC。",
