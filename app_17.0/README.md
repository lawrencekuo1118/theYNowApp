...
- **PDF 個股報告**：logo 藍／綠色系（`#0C5484`／`#249C60`）；券商風格編號「分析說明」段落；章節壹～肆（投資建議／公司概況／成長動能／情境評估）；僅標的分析
- **Lite 精簡 PDF**：Lite 模式下載省略財報附錄（檔名含 `_Lite`）；Full 保留完整附錄
- **目錄**：`app_17.0/`；顯示版號 **v17.92**
