...
lab_gics_subindustry_map <- function() {
  c(
    ...
    "Agricultural Products & Services" = "ag.Agriculture",
    ...
    "Environmental & Facilities Services" = "en.Environmental",
    ...
    "IT Consulting & Other Services" = "tech.IT_Services",
    "Leisure Products" = "cons.Sports_Leisure",
    "Life & Health Insurance" = "fn.Insurance",
    "Life Sciences Tools & Services" = "hc.Medtech",
    "Managed Health Care" = "hc.Healthcare_Services",
    "Metal, Glass & Plastic Containers" = "mat.Paper_Packaging",
    ...
    "Paper & Plastic Packaging Products & Materials" = "mat.Paper_Packaging",
    ...
    "Research & Consulting Services" = "bus.Professional_Services",
    "Restaurants" = "cons.Restaurants",
    ...
    "Technology Distributors" = "tech.Electronics_Distribution",
