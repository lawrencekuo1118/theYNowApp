...
.UI_STRINGS <- list(
  en = list(
    ...
    hfv_sum_conclusion_na = "No conclusion yet: need realized next-period pairs under the current validation sample scope (and checked FV models).",
  ...
  `zh-TW` = list(
    ...
    hfv_sum_conclusion_na = "尚無結論：需在目前驗證樣本口徑下有已實現下期配對（並勾選評價模型）。",
